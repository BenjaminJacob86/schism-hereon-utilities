...
# 
file='mon_Ana_mveg_jan_2017_01_a.nc' #'mon_Ana_mveg_jan_2017_01.nc'
file='c_mon_Ana_mveg_jan_2017_2017-10-27_2017-10-30.nc' 
dsc=xr.open_dataset(file)
mon=1 # month of analyiss


#surface bottom
#image_outdir='./monthly_stats/'
image_outdir='./period_stats/'
prefix='2017_2017-10-27_2017-10-30' # for output nc file

## selected varnames
varnames=['elevation','sigWaveHeight','depthAverageVel']

units={'elevation':'m','sigWaveHeight':'m','depthAverageVel':'m/s'}
symbols={'elevation':'$\zeta$','sigWaveHeight':'HS','depthAverageVel':'$u_{<z>}$'}
