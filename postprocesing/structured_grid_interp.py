...
std_names={'elev':'sea_water_elevation', 'salt':'surface_sea_water_salinity', 'temp':'surface_sea_water_temperature', 'u':'surface_eastward_sea_water_velocity', 'v':'surface_northward_sea_water_velocity', 'velocity_magnitude':'m/s'}
...
for varname in varnames:
	...
	if varname=='elev':
		...
		da.to_netcdf('schism_interp_20230101c.nc',mode='w')
	else:
