...
if len(sys.argv)>2:
        date0=str(int(sys.argv[1]))
        date1=str(int(sys.argv[2]))
        print(mon0)
        print(mon1)
else:
        #Herwart
...
setupdir = ['/work/gg0028/g260114/RUNS/Rest-Coast/NoSeagrass/r212/',
            '/work/gg0028/g260114/RUNS/Rest-Coast/Veg_LE/r212/',
            '/work/gg0028/g260114/RUNS/Rest-Coast/Veg_max/r212/']
outdir = '/work/gg0028/g260114/RUNS/Rest-Coast/r212_stats_extract2_year'+date0+'_'+date1+'/'  # output directory

# Folders of involded scenarios
setupdir = ['/work/gg0028/g260114/RUNS/Rest-Coast/NoSeagrass/r212_1997/',
            '/work/gg0028/g260114/RUNS/Rest-Coast/Veg_max/r212_1997/']
outdir = '/work/gg0028/g260114/RUNS/Rest-Coast/analysis/1997_stats/'+date0+'_'+date1+'/'  # output directory
...
experiments = ['Veg_CNTRL', 'Veg_max'] #, 'Veg_LE', 'Veg_LE'
basedir = setupdir[0]

## statistics to compute: # potential quantaties (percentiles, eg.   'quantile95','quantile5', ...
quantaties = ['mean', 'min', 'max', 'quantile95']  # ['mean','min','max','std','quantile95']
        ...
        for irun in range(nrun):
            ...
            for iquant, quanti in enumerate(quantaties):  # statistical quantaty loop
                ...
                if 'quantile' in quanti:
                    ...
                    datab=np.asarray(data)
                    datab[data.mask]=np.nan
                    results[expi][vari][quanti] = tmp = np.nanquantile(datab, axis=0, q=value)
