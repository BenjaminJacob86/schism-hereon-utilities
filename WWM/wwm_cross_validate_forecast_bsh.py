...
WWMdirs=['/gpfs/work/jacobb/data/RUNS/routine_GB_wave/','/gpfs/work/jacobb/data/RUNS/routine_GB_wave/from_mistral/default/','/gpfs/work/jacobb/data/RUNS/routine_GB_wave/from_mistral/Bmax1.34/','/gpfs/work/jacobb/data/RUNS/routine_GB_wave/from_mistral/Bmax1.52Code/']

wwm_names=['WWM_FRC_DWD','WWM_FRC_DWD_corry','WWM_FRC_DWD_Bmax_1.34','WWM_FRC_DWD_Bmax_1.54']  # names of scenario for display
wwm_descriptions=[': WWM DWD forecast run with betamax of 1.54',':same with corrected ww3 boundary application',':Bmax reduced',':switch set in code using Bmax 1.52']
...
image_output_dir='/gpfs/work/jacobb/data/RUNS/routine_GB_wave/bouy_validation/'
