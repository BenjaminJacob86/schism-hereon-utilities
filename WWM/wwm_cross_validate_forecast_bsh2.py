...
########### SETTINGS #########
pdfname="WWM_Validation_2021Forecast_WW3Bmax13_300s_WWV_WW3GB.pdf" # name of image pdf
image_output_dir='/gpfs/work/jacobb/data/RUNS/routine_GB_wave/bouy_validation_incTM2/'
...
maxdate=np.datetime64('2021-08-31') # manually set maximumdate
...
WWMdirs=['/gpfs/work/jacobb/data/RUNS/routine_GB_wave/from_mistral/Bmax1.3_300sec/','/gpfs/work/jacobb/data/RUNS/routine_GB_wave/from_mistral/codeAron/']

#wwm_names=['WWM_FRC_DWD_Bmax_Default','Bmax1.3','WWM_dt_300s']  # names of scenario for display
wwm_names=['WWM3_dt_300s','WWMV_dt_300s']  # names of scenario for display
#': WWM DWD forecast run with default betamax of 1.54',': same but Betmax reduced to 1.3','
wwm_descriptions=['WWM1.3Bmax@300s','WWMV1.54Bmax@300s']
comments='' 
...
ww3PointOutput=[ww3dirs[0]+'ww3.2021_08_09_spec.nc',ww3dirs[1]+'ww3.202108_spec.nc']#ww3dirs[1]+'ww3.2021_08_09_spec.nc',ww3dirs[2]+'ww3.2021_08_09_spec.nc'] 
...
#,': WW3 run with betamax of 1.6 forced with DWD forecast '
if not addWW3:
	ww3_names=[]
...
for varnameBSH in varnamesBSH:
	...
	im = Image(taylor[varnameBSH][0],4.5*inch,4*inch)
	Story.append(im)
...
## ww3.plotAtnodes(ww3.gridds['hs'][0,:])
#for ti in range(501,525):
#	plt.clf()
#	ph,ch=ww3.plotAtnodes(ww3.gridds['hs'][ti,:])
#	plt.title(str(ww3.gridds['time'][ti].values)[:16])
#	plt.clim((0,1))
#	ch.set_label('hs')
#	plt.savefig('{:04d}_hsWW3GB.png'.format(ti),dpi=200)
#
## test
# 
# dir='./'	
...
#	ch.set_label('hs [m]')
#	plt.clim((0,2))
#	plt.title(str(ww3.gridds['time'][ti].values)[:19])
#	plt.savefig('ww3_{:04d}_hs'.format(ti),dpi=200)	
