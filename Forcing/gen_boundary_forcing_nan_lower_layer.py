...
t0=dt.datetime(2021,10,23)		#  time start WK
t1=dt.datetime(2021,10,24)		#  time end WK
...
frcdir='/gpfs/work/jacobb/data/RUNS/BlackSea/BS4routine/download_cmems/blacksea/' # forcing directory WK
																				  # with data downloaded by	download_med_fc.sh				
