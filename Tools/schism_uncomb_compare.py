...
# launch for second setup
root2 = tk.Tk()
root2.geometry("400x580")
root2.grid_rowconfigure(12, minsize=100)  
root2.grid_columnconfigure(4, minsize=100)  
app2= Window(root2)
...
for i,appi in enumerate(apps):
	appi.variable.set(varname)
	appi.lvl_tk.set(20)
...
for i,appi in enumerate(apps):
	...
	plt.clf()
	plt.subplot(1,2,i+1)
	appi.schism_plotAtelems(nodevalues,appi.nodevalues)
...
app2.lvl_tk.set(20)
        ...
        app.dryelems=np.zeros(self.stp.nelements)	
