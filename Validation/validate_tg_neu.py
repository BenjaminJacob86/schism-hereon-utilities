...
sys.path.insert(0,'/pf/g/g260114/git/schism-hzg-utilities/Lib/')
...
setupdir=['/work/gg0028/g260126/SCHISM/schism_cfgs/SNS_GB_Control/'] #['/gpfs/work/jacobb/data/SETUPS/NorthSea/NorthSea200mHelgoland/RERUN/']  # schism run directory, containts hgrid.* etc.
ncdir=[setupdir[0] + 'combined/'] 		  #   directory of schism nc output or station output
use_station_in=[True]					  # True: use station output False: extract from netcdf (slow)
...
#plt.plot(stations['schism_HR_Ballje']['time'],stations['schism_HR_Ballje']['zeta'][:,i])
