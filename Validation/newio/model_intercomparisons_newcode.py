...
# SCHIMS grid files
setupdir=['/work/gg0028/g260114/SETUPS/NWBS/setup/newcode/NWBS_danube_repair/NWBS_quad_split/']
...
outdir='/work/gg0028/g260114/SETUPS/NWBS/setup/newcode/NWBS_danube_repair/comp/'
if not os.path.exists(outdir): os.mkdir(outdir) 

names=['CMEMS','NWBS_S','NWBS_vgrid_re']
...
vartimes={'ssh':{'startdate':dt.datetime(2018,1,1,1,0),'enddate':dt.datetime(2018,3,1,1,0),'step[hours]':1},\
