...
ph=plt.scatter(x[datapoints[tag]],y[datapoints[tag]],s=15,c=temp[datapoints[tag]])
plt.colorbar(ph)


		
		
# nearest two points inverste distance weighted	
	
	
plt.text(station['East'],station['North'],name.replace(' ','\n'),rotation=45)
